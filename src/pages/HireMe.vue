<template>
    <div class="container mx-auto md:flex items-center justify-center pt-28" style="min-height: 93vh;">
        <div class=" px-10 md:p-10 min-w-96 md:border border-gray-200 flex flex-col gap-4">
            ...
            <div class="text-xs bg-blue-50 border border-blue-300 px-3 py-1" v-if="status.sending">
                Sending mail...
            </div>
            ...
            <form class="flex flex-col gap-4">
                <div class="flex flex-col gap-2">
                    ...
                    <div class=" px-4 border border-gray-300 focus-within:border-blue-500 flex focus-within:text-blue-500 items-center gap-3">
                ...
                <div class=" flex flex-col gap-2">
                    ...
                    <textarea v-model="form.message" class=" pt-1 focus:border-blue-500 resize-none text-gray-900 focus:outline-none px-4 border h-48 border-gray-300" required placeholder="Discuss job details..."/>
                </div>

                <button :disabled="status.sending" @click.prevent="sendMail" type="submit" class=" cursor-pointer bg-gray-900 w-full flex items-center justify-center text-white h-16">
